    ...
    <Form {...form}>
      ...
      >
        ...
        <div className="links flex flex-col justify-center items-center">
          <Link href={"/forgot-password"} className='text-sm hover:text-amber-600 mb-4'>Forgot password?</Link>
          <Separator />
          <span>or</span>
          <Link href={"/signup"} className='underline mt-2 font-medium'>Create new account</Link>
        </div>
      </form>
    </Form>
  )
